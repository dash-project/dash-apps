...
plot \
    ...
    'trace.csv' using 7:( strcol(2) eq "smoothen res" ? $6 : 1/0 ) with points ps 1 t "smoothen res", \
...
plot \
    ...
    'trace.csv' using 7:( strcol(2) eq "smoothen res" ? $8/$6 : 1/0 ) with points ps 1 t "smoothen res"
