...
proc main() {
  ...
  fprintf( FILE_PTR, "Chapel,Chain  ,%5u,%5u,%3u,%5u,%2u,%.9lf,isBench:%d\n", nelts, nelts, thresh_percent, winnow_nelts, dataParTasksPerLocale, is_bench, accum ); //, locale.totalThreads()
  fclose ( FILE_PTR );
